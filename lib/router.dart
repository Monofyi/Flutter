...
import 'package:inventory_management/ui/list_details/supplier_page_new/supplier_add.dart';
...
import 'ui/list_details/supplier_page_new/supplier_alert.dart';
...
class GlobalRouter implements RouterInterface, ScreenNameInterface {
  ...
  final _routes = <String, RouteConfiguration>{
    ...
    SuppliersListPage.routeName: _standardRoute(
      (context, settings) => SuppliersListPage.wrapped(),
    ),
    SupplierAdd.routeName: _standardRoute(
      (context, settings) => SupplierAdd.wrapped(),
    ),
    SupplierAlert.routeName: _standardRoute(
      (context, settings) =>
          SupplierAlert.wrapped(settings.arguments as SupplierAlertArgument),
    ),
    SupplierConfirmation.routeName: _standardRoute(
      (context, settings) => SupplierConfirmation.wrapped(),
    ),
    SignUpPage.routeName: _standardRoute(
      (context, settings) => SignUpPage.wrapped(),
    ),
